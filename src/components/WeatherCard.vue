...
<template>
    <div class="text-white p-10 rounded-lg shadow-lg gap-6 mb-6 relative overflow-hidden bg-blue-400">
        <!-- Location & time -->
        <div class="mb-2 flex justify-between items-center">
            ...
            <div class="flex items-center justify-center gap-2">
                ...
                <h1 class="text-3xl">{{ new Date(place.location.localtime).getHours() }}:{{ new
                    Date(place.location.localtime).getMinutes() }}</h1>
            </div>
        </div>
